...
(use-package! org-modern
  ...
  :config
  ;; Headline bullets – inspired by Tokyo Night hues
  ...
  ;; Use a little padding for headers
  (custom-set-faces!
    '(org-modern-tag :background "#2a2f4a" :foreground "#7aa2f7" :weight bold)
    '(org-modern-date-active :foreground "#9ece6a")
    '(org-modern-date-inactive :foreground "#565f89")
    '(org-modern-symbol :foreground "#bb9af7")
    '(org-modern-done :foreground "#9ece6a" :weight bold)
    '(org-modern-todo :foreground "#f7768e" :weight bold)))

;; Optional: disable org-superstar if using (org +pretty)
