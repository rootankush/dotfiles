...
keys = [
    ...
    Key([mod], "w", lazy.spawn(terminal), desc="alacritty"),
...
layouts = [
    # layout.Columns(border_focus_stack=["#00ffff", "#00ff00"], border_width=5),
    # layout.Max(),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.GroupBox(
                    active=["#e74c3c"],
                    block_highlight_text_color=["#aad688"],
                    highlight_method="block",
                    highlight_color=["453f3d"],
                    center_aligned= True,
                    foreground="#ff0000",
                    ),
                widget.Prompt(),
